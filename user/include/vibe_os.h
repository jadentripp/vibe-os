...
enum {
    ...
    VIBE_PROCESS_KIND_APP_PRIMARY = 2,
    VIBE_PROCESS_KIND_PREEMPT_PROBE = 3,
    VIBE_PROCESS_KIND_GENERIC = 4,
    VIBE_PROCESS_KIND_APP_SECONDARY = 5,
};
...
enum {
    VIBE_APP_PERSIST_ACTION_STATUS = 0x10000000u,
    VIBE_APP_PERSIST_ACTION_SEND = 0x0001u,
    VIBE_APP_PERSIST_ACTION_UI_ACTIVE = 0x0002u,
    VIBE_APP_PERSIST_ACTION_DESCRIPTION = 0x0004u,
    VIBE_APP_PERSIST_ACTION_WRITE_REQUESTED = 0x0008u,
    VIBE_APP_PERSIST_ACTION_WRITE_DONE = 0x0010u,
    VIBE_APP_PERSIST_ACTION_READ_REQUESTED = 0x0020u,
    VIBE_APP_PERSIST_ACTION_READ_DONE = 0x0040u,
    VIBE_APP_PERSIST_ACTION_STREAM = 0x0080u,
    VIBE_APP_PERSIST_ACTION_OP_SHIFT = 8,
    VIBE_APP_PERSIST_ACTION_SLOT_SHIFT = 16,
};

enum {
    VIBE_APP_PERSIST_IO_STATUS = 0x20000000u,
    VIBE_APP_PERSIST_IO_OPEN = 0x0001u,
    VIBE_APP_PERSIST_IO_READ = 0x0002u,
    VIBE_APP_PERSIST_IO_WRITE = 0x0004u,
    VIBE_APP_PERSIST_IO_CLOSE = 0x0008u,
    VIBE_APP_PERSIST_IO_SLOT_SHIFT = 16,
};

enum {
    /* Compatibility aliases for existing save/load app instrumentation. */
    VIBE_APP_SAVEACTION_STATUS = VIBE_APP_PERSIST_ACTION_STATUS,
    VIBE_APP_SAVEACTION_SENDSAVE = VIBE_APP_PERSIST_ACTION_SEND,
    VIBE_APP_SAVEACTION_MENUACTIVE = VIBE_APP_PERSIST_ACTION_UI_ACTIVE,
    VIBE_APP_SAVEACTION_DESCRIPTION = VIBE_APP_PERSIST_ACTION_DESCRIPTION,
    VIBE_APP_SAVEACTION_SAVE_REQUESTED = VIBE_APP_PERSIST_ACTION_WRITE_REQUESTED,
    VIBE_APP_SAVEACTION_SAVE_DONE = VIBE_APP_PERSIST_ACTION_WRITE_DONE,
    VIBE_APP_SAVEACTION_LOAD_REQUESTED = VIBE_APP_PERSIST_ACTION_READ_REQUESTED,
    VIBE_APP_SAVEACTION_LOAD_DONE = VIBE_APP_PERSIST_ACTION_READ_DONE,
    VIBE_APP_SAVEACTION_STREAM = VIBE_APP_PERSIST_ACTION_STREAM,
    VIBE_APP_SAVEACTION_GAMEACTION_SHIFT = VIBE_APP_PERSIST_ACTION_OP_SHIFT,
    VIBE_APP_SAVEACTION_SLOT_SHIFT = VIBE_APP_PERSIST_ACTION_SLOT_SHIFT,
    VIBE_APP_SAVELOAD_STATUS = VIBE_APP_PERSIST_IO_STATUS,
    VIBE_APP_SAVELOAD_OPEN = VIBE_APP_PERSIST_IO_OPEN,
    VIBE_APP_SAVELOAD_READ = VIBE_APP_PERSIST_IO_READ,
    VIBE_APP_SAVELOAD_WRITE = VIBE_APP_PERSIST_IO_WRITE,
    VIBE_APP_SAVELOAD_CLOSE = VIBE_APP_PERSIST_IO_CLOSE,
    VIBE_APP_SAVELOAD_SLOT_SHIFT = VIBE_APP_PERSIST_IO_SLOT_SHIFT,
};

enum {
    VIBE_APP_INIT_STATUS = 0x40000000u,
    VIBE_APP_INIT_START = 0x0001u,
    VIBE_APP_INIT_I_INIT = 0x0002u,
    VIBE_APP_INIT_ZONE = 0x0004u,
    VIBE_APP_INIT_NETWORK = 0x0008u,
    VIBE_APP_INIT_SOUND = 0x0010u,
    VIBE_APP_INIT_GRAPHICS = 0x0020u,
    VIBE_APP_INIT_PALETTE = 0x0040u,
    VIBE_APP_INIT_TIC = 0x0080u,
    VIBE_APP_INIT_FRAME = 0x0100u,
};
