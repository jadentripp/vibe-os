...
#define PI4_VIBE_MIN_APP_RECORD_COUNT 1
...
#error "Pi 4 app-record ABI must fit the visible launcher app cards"
#endif

#if PI4_VIBE_APP_RECORD_COUNT < PI4_VIBE_VISIBLE_APP_RECORD_COUNT
#error "Pi 4 visible app records must fit inside app-record capacity"
#endif
...
#define PI4_VIBE_APP_RECORD_MANIFEST_FD_LIMIT \
    (PI4_VIBE_APP_RECORD_MANIFEST_FD_FIRST + \
     PI4_VIBE_APP_RECORD_MANIFEST_FD_COUNT)
#define PI4_VIBE_APP_RECORD_MANIFEST_FD_LAST \
    (PI4_VIBE_APP_RECORD_MANIFEST_FD_LIMIT - 1)
#define PI4_VIBE_APP_RECORD_ELF_FD_FIRST \
    PI4_VIBE_APP_RECORD_MANIFEST_FD_LIMIT
#define PI4_VIBE_APP_RECORD_ELF_FD_COUNT PI4_VIBE_APP_RECORD_COUNT
#define PI4_VIBE_APP_RECORD_ELF_FD_LIMIT \
    (PI4_VIBE_APP_RECORD_ELF_FD_FIRST + PI4_VIBE_APP_RECORD_ELF_FD_COUNT)
#define PI4_VIBE_APP_RECORD_ELF_FD_LAST \
    (PI4_VIBE_APP_RECORD_ELF_FD_LIMIT - 1)
#define PI4_VIBE_FD_APP_MANIFEST_BASE \
    PI4_VIBE_APP_RECORD_MANIFEST_FD_FIRST
#define PI4_VIBE_FD_APP_MANIFEST_COUNT \
    PI4_VIBE_APP_RECORD_MANIFEST_FD_COUNT
