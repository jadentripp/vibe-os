...
- Those hardware-facing claims are bounded by `docs/architecture.md` to the
...
- The fastest safe human try path is `docs/play.md`: use a
  ...
  human proof flow lives in `docs/play.md`.
