...
grep -q 'symbol=pi4_storage_status_app_doom_elf addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_quake_elf addr=' "$OUT_DIR/kernel8.map"
...
grep -q 'symbol=pi4_storage_status_app_doom_elf_entry_index addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_doom_elf_attr addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_doom_elf_cluster addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_doom_elf_size addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_doom_elf_plan_lba addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_doom_elf_plan_sectors addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_doom_elf_plan_bytes addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_doom_elf_read_count addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_quake_elf_entry_index addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_quake_elf_attr addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_quake_elf_cluster addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_quake_elf_size addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_quake_elf_plan_lba addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_quake_elf_plan_sectors addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_quake_elf_plan_bytes addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_app_quake_elf_read_count addr=' "$OUT_DIR/kernel8.map"
