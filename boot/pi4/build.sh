...
PI4_STORAGE_APP_RECORD_0_ELF_SYMBOL=pi4_storage_status_app0_elf
PI4_STORAGE_APP_RECORD_1_ELF_SYMBOL=pi4_storage_status_app1_elf
...
grep -a -q '/APPS/' "$OUT_DIR/kernel8.img"
grep -a -q '/APPS/INDEX.TXT' "$OUT_DIR/kernel8.img"
grep -a -q 'APP.TXT' "$OUT_DIR/kernel8.img"
...
grep -q "symbol=$PI4_STORAGE_APP_RECORD_0_ELF_SYMBOL addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=$PI4_STORAGE_APP_RECORD_1_ELF_SYMBOL addr=" "$OUT_DIR/kernel8.map"
...
grep -q "symbol=${PI4_STORAGE_APP_RECORD_0_ELF_SYMBOL}_entry_index addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_0_ELF_SYMBOL}_attr addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_0_ELF_SYMBOL}_cluster addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_0_ELF_SYMBOL}_size addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_0_ELF_SYMBOL}_plan_lba addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_0_ELF_SYMBOL}_plan_sectors addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_0_ELF_SYMBOL}_plan_bytes addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_0_ELF_SYMBOL}_read_count addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_1_ELF_SYMBOL}_entry_index addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_1_ELF_SYMBOL}_attr addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_1_ELF_SYMBOL}_cluster addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_1_ELF_SYMBOL}_size addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_1_ELF_SYMBOL}_plan_lba addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_1_ELF_SYMBOL}_plan_sectors addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_1_ELF_SYMBOL}_plan_bytes addr=" "$OUT_DIR/kernel8.map"
grep -q "symbol=${PI4_STORAGE_APP_RECORD_1_ELF_SYMBOL}_read_count addr=" "$OUT_DIR/kernel8.map"
