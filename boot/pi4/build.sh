...
grep -a -q 'PI4ELFPROBE' "$OUT_DIR/kernel8.img"
grep -a -q 'INIT.ELF' "$OUT_DIR/kernel8.img"
grep -a -q 'PAYLOAD0.ELF' "$OUT_DIR/kernel8.img"
grep -a -q 'PAYLOAD1.ELF' "$OUT_DIR/kernel8.img"
...
grep -q 'symbol=pi4_storage_name_payload0_elf addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_name_payload1_elf addr=' "$OUT_DIR/kernel8.map"
...
grep -q 'symbol=pi4_storage_status_payload0 addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload1 addr=' "$OUT_DIR/kernel8.map"
...
grep -q 'symbol=pi4_storage_status_payload0_entry_index addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload0_attr addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload0_cluster addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload0_size addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload0_plan_lba addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload0_plan_sectors addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload0_plan_bytes addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload0_read_count addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload1_entry_index addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload1_attr addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload1_cluster addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload1_size addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload1_plan_lba addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload1_plan_sectors addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload1_plan_bytes addr=' "$OUT_DIR/kernel8.map"
grep -q 'symbol=pi4_storage_status_payload1_read_count addr=' "$OUT_DIR/kernel8.map"
