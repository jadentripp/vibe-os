...
#   /BIN/FD.ELF, /BIN/DEVNULL.ELF, /BIN/LLSEEK.ELF, /BIN/MMAPLG.ELF,
#   /BIN/PIPE.ELF, /BIN/FORK.ELF, /BIN/CLONE3.ELF,
#   /BIN/PROCEXE.ELF, /BIN/TMPDIR.ELF, /BIN/PROCID.ELF,
#   /BIN/LDSOHDR.ELF, /BIN/LDSOREL.ELF, /BIN/EXECVE.ELF, /BIN/VFORKEX.ELF,
#   /BIN/VFORKCH.ELF, /BIN/VFORKXGP.ELF, /BIN/VFORKXG.ELF, and the current
