...
class SourceContractTests(unittest.TestCase):
    def test_local_vm_targets_are_opt_in(self):
        ...
        self.assertIn("slot_marker_payload=", real_wad_workflow)
        ...
        self.assertIn("name = make_wad_image.SAVE_REQUEST_NAME", real_wad_workflow)
        self.assertIn("name = make_wad_image.LOAD_REQUEST_NAME", real_wad_workflow)
        self.assertIn('data = marker_payload.encode("ascii")', real_wad_workflow)
        ...
        self.assertIn("read_persistence_slot_request(", platform)
