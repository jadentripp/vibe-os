...
class SourceContractTests(unittest.TestCase):
    def test_local_vm_targets_are_opt_in(self):
        ...
        self.assertIn("wait-status-min=leveltime:00000001:90:2", real_wad_workflow)
    ...
    def test_kernel_has_dynamic_fat16_writable_file_path(self):
        ...
        for source in (
            ...
            self.assertIn(source, kernel)
        self.assertIn('savereq_name_83 db "SAVEREQ CHK"', kernel)
        self.assertIn('loadreq_name_83 db "LOADREQ CHK"', kernel)
