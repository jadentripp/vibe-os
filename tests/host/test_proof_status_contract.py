...
def status_line(**overrides):
    fields = {
        ...
        "doomsound": "00000000",
        "sfxmix": "00000000",
        "sfxq": "00000000:00000000:00000000:00000000",
        "sfxbytes": "00000000:00000000",
        "sfxdma": "00000000:00000000",
        "sfxsrc": "00000000",
        "sfxlast": "00000000:00000000:00000000",
        "voices": "00000000",
        "sfxvoices": "00000000",
        "audioirq": "00000000",
        "ack8": "00000000",
        ...
        "pcmstream": "00000000:00000000:00000000:00000000:00000000",
        "pcmwrite": "00000000:00000000:00000000:00000000",
        "pcmqueue": "00002000:00000000:00000000:00000000:00000000:00000000",
        "pcmpull": "00000000:00000000:00000000",
        "pcmirq": "00000000:00000000:00000000",
        "pcmdma": "00000000:00000000:00000000:00001000:00000000:00000FFF",
...
class ProofStatusContractTests(unittest.TestCase):
    ...
    def test_real_wad_checker_rejects_weak_system_or_fake_debug_status(self):
        invalid = (
            ...
            status_line(peflags="00003202:00000202:00000202:00000000:00000001"),
            status_line(peflags="00000202:00003202:00000202:00000000:00000001"),
            status_line(peflags="00000202:00000202:00003202:00000000:00000001"),
            status_line(peflags="00000202:00000202:00000202:00000000:00000000"),
    ...
    def test_workflow_artifacts_are_status_only_for_real_wad_proof(self):
        ...
        upload_block = workflow.split("Upload status-only proof artifact", 1)[1]
        for forbidden in (
            "build/disk.img",
            "build/gfx.bin",
            "build/vga*.txt",
